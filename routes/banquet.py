...
from models import db, BanquetBooking
from datetime import datetime, date

banquet_bp = Blueprint('banquet_bp', __name__)
...
@banquet_bp.route('/book', methods=['GET', 'POST'])
def book():
    ...
    if request.method == 'POST':
        ...
        if not event_type or not event_date_str or not customer_name or not phone:
            ...
            return render_template('banquet_booking.html', today=today)
        ...
        flash(f'Booking enquiry submitted! Your Reference ID: {booking.booking_id}', 'success')
